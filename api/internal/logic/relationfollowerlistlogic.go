...
func (l *RelationFollowerListLogic) RelationFollowerList(req *types.RelationFollowList) (resp *types.RelationFollowListResp, err error) {
	// 显示粉丝列表
	// Token -> ID
	...
	// 根据ID获取粉丝列表
	ids, err := l.svcCtx.Interaction.FollowerList(l.ctx, &interaction.FollowerListRequest{
		UserId: id.UserId,
	})
